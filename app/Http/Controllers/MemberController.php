    ...
    public function listData()
    {
        ...
        foreach($member as $list) {
            ...
            $row[] = "<div class='btn-group'>
                        <a onclick='editForm(".$list->id_member.")' class='btn btn-info btn-sm'><i class='fas fa-pen'></i></a>
                        &nbsp;&nbsp;
                        <a onclick='deleteData(".$list->id_member.")' class='btn btn-danger btn-sm'><i class='fas fa-trash'></i></a>
                      </div>";
            $data[] = $row;
        }
